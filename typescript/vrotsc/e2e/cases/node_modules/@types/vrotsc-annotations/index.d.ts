...
// ---------------------------------------------- Workflow Binding Export Decorator ------------------------------------------------
/**
 * Standalone decorator that allows overriding the export-name used for a
 * workflow item binding for the given method.
 *
 * Example usage:
 *
 *   @BindingExport("foo", "FOO_ENV")
 *   myItem(foo: string) { ... }
 *
 * where "foo" is the name of a parameter on the decorated method.
 */
export declare function BindingExport(bindName: string, exportName: string): MethodDecorator;
